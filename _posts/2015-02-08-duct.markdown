...
The whole thing is deployable using Docker - more information on that in the [README](https://github.com/jstaffans/pay-me). The source code is [available on GitHub](https://github.com/jstaffans/pay-me).
